  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> profileOtherUsersRecordList = snapshot.data!;
        final profileOtherUsersRecord = profileOtherUsersRecordList.isNotEmpty
            ? profileOtherUsersRecordList.first
            : null;
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Image.network(
                                  valueOrDefault<String>(
                                    profileOtherUsersRecord.photoUrl,
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 8.0, 0.0, 0.0),
                                child: Text(
                                  profileOtherUsersRecord.username,
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          formatNumber(
                                            profileOtherUsersRecord.totalLikes,
                                            formatType: FormatType.compact,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .titleMedium
                              ...
                              if (!(currentUserDocument?.following.toList() ??
                                      [])
                                  .contains(profileOtherUsersRecord.reference))
                                AuthUserStreamWidget(
                                  builder: (context) => FFButtonWidget(
                                    onPressed: () async {
                                        ...
                                        ...mapToFirestore(
                                          {
                                            'following': FieldValue.arrayUnion([
                                              profileOtherUsersRecord.reference
                                            ]),
                                          },
                                        ),
                                      });

                                      await profileOtherUsersRecord.reference
                                          .update({
                                        ...mapToFirestore(
                                          {
                                      ...
                                      _model.timerFollowButtonController
                                          .onStartTimer();
                                    },
                                    text: 'Follow',
                              ...
                              FlutterFlowTimer(
                                initialTime:
                                    _model.timerFollowButtonInitialTimeMs,
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 10.0, 0.0, 0.0),
                                child: Text(
                                  profileOtherUsersRecord.userBio,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        font: GoogleFonts.poppins(
                                      ...
                                      StreamBuilder<List<VideosRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return GridView.builder(
                                            ...
                                            itemCount:
                                                gridViewVideosRecordList.length,
                                            itemBuilder:

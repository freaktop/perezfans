...
import '/empty_state/empty_comments/empty_comments_widget.dart';
                        ...
                        return Padding(
                          ...
                          child: StreamBuilder<UsersRecord>(
                            stream: UsersRecord.getDocument(
                                columnCommentsRecord.commentUser!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        validator: _model.commentInputTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                  InkWell(
                    ...
                    onTap: () async {
                      ...
                      await CommentsRecord.createDoc(widget.videoRef!)
                          .set(createCommentsRecordData(
                        commentUser: currentUserReference,
                        commentTime: getCurrentTimestamp,
                        commentText: _model.commentInputTextController.text,
                      ));
                      safeSetState(() {
                        _model.commentInputTextController?.clear();
                      });

                      await widget.videoRef!.update({
                        ...mapToFirestore(
                          {
                            'video_comment_num': FieldValue.increment(1),
                          },
                        ),
                      });
                    },

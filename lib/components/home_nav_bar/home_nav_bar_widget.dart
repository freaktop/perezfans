                ...
                InkWell(
                  ...
                  onTap: () async {
                    ...
                    if (selectedMedia != null &&
                      ...
                      safeSetState(
                          () => _model.isDataUploading_uploadMediaOlu = true);
                      ...
                      try {
                        ...
                        _model.isDataUploading_uploadMediaOlu = false;
                      }
                      if (selectedUploadedFiles.length ==
                              selectedMedia.length &&
                          downloadUrls.length == selectedMedia.length) {
                        safeSetState(() {
                          _model.uploadedLocalFile_uploadMediaOlu =
                              selectedUploadedFiles.first;
                          _model.uploadedFileUrl_uploadMediaOlu =
                              downloadUrls.first;
                        });
                      } else {
                        safeSetState(() {});
                    ...
                    if (_model.uploadedFileUrl_uploadMediaOlu != '') {
                      FFAppState().newVideo =
                          _model.uploadedFileUrl_uploadMediaOlu;
                      FFAppState().update(() {});

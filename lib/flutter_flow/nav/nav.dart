      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: OnboardingNameWidget.routeName,
              path: OnboardingNameWidget.routePath,
              builder: (context, params) => OnboardingNameWidget(),
            ),
            FFRoute(
              name: OnboardingUsernameWidget.routeName,
              path: OnboardingUsernameWidget.routePath,
              builder: (context, params) => OnboardingUsernameWidget(),
            ),
            FFRoute(
              name: SingleVideoWidget.routeName,
              path: SingleVideoWidget.routePath,
